...
class MyAuth_User_Controller extends Base_Controller{
	...
	public function action_signup(){
		...
		$user_data = array( 'email' => Input::get('email'), 'username' => Input::get('username'), 'password' => Hash::make(Input::get('password')) ); 
	    ...
	    return Redirect::to($redirect_url)->with('notification-signup', 'Du har nu skapat ett konto på pubguiden! Logga in och börja betygsätt.');
